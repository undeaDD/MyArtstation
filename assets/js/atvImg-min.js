...
function atvImg() {
    ...
    function processEnter(e, elem) {
        elem.firstChild.className += ' over atvImg-active';
        elem.className += ' atvImg-active';
    }

    function processExit(e, elem, layers, totalLayers, shine) {

        var container = elem.firstChild;
        elem.classList.remove('atvImg-active');
        container.className = container.className.replace(' over atvImg-active', '');
